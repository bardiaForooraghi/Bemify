    ...
    <div>
        <b-row class="justify-content-center search">
            <b-row class="justify-content-center search-row">
              <b-col>
                <input type="search" v-model="username" style="border: none;" id="search-input" placeholder="Start looking for something!"
          ...
          <b-col class="mx-auto" id="search-results">
            <b-row>
              <b-col class="col-5" id="user-results">
                <!-- <p>User results</p> -->
                <b-row class="mx-auto" id="userResult" v-for="User in users" :key="User">
                ...
                <b-col class="col-5 ml-auto">
                  ...
                  <button class="unfollowButton" @click="unfollowAccount(User._id)">Unfollow</button>
                </b-col>
                </b-row>
            </b-col>
            <b-col class="col-7" id="song-results">
              <!-- <p v-if="user =>1">Song results</p> -->
              <b-row class="mx-auto" id="songResult" v-for="User in users" :key="User">
                ...
                <b-col class="col-3 ml-auto">
                  <img class="button saveButton" @click="save(song)" src="../../../images/plus.png" alt="saveButton" id="plus">
                </b-col>
              </b-row>
          </b-col>
            </b-row>
